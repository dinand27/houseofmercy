<div class="container-fluid">
	...
	<?php echo anchor('administrator/wilayah/komsel_detail/'.$dt->komsel_id,'<div class="btn btn-warning mt-1">Kembali</div>'); ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						...
						<img class="card-img-top" src="<?php echo base_url('uploads/').$dt->foto; ?>" alt="<?php echo $dt->foto ?>" style="width: auto; height:170px" >

...
<?php foreach($perorangan as $kk): ?>
        <i class="fas fa-university"></i> <strong>Edit : <span><?php echo $kk->nama ?></span> </strong>
    </div>
<form method="post" action="<?php echo base_url('administrator/perorangan/update_aksi'); ?>" >
<div class="container">
    <div class="row justify-content-md-right">
<input type="hidden" name="user" id="" value="<?php echo $this->session->userdata('username'); ?>">
<input type="hidden" name="id" id="" value="<?php echo $kk->id ?>">
        ...
        <div class="col-md-auto">
        <div class="form-group">
        <label>Kota/Kabupaten <cite class="text-danger">*</cite></label>
            <select name="nmKota" class="form-control form-control">
            <option value="<?php echo $kk->nmKota ?>"><?php echo $kk->nmKota ?></option>
        ...
        <div class="form-group">
            <label>No.HP</label>
            <input type="text" name="hp" class="form-control" value="<?php echo $kk->hp ?>">
           </div>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="komsel" class="form-control form-control">
            <option value="<?php echo $kk->komsel ?>"><?php echo $kk->komsel ?></option>
				<?php foreach($komsel as $s): ?>
				<option value="<?php echo $s->nama_komsel; ?>"><?php echo $s->nama_komsel; ?></option>
				<?php endforeach; ?>
            </select>
        </div>
        </div>
        ...
        <div class="col-md-auto">
        <div class="form-group">
            <label>Bidang Pelayanan <cite class="text-danger">*</cite></label>
            <select name="bidang_pelayanan" class="form-control form-control">
            <option value="<?php echo $kk->bidang_pelayanan ?>"><?php echo $kk->bidang_pelayanan ?></option>
            <?php foreach($pelayanan as $pel): ?>
            <option value="<?php echo $pel->pelayanan; ?>"><?php echo $pel->pelayanan; ?></option>
            <?php endforeach; ?>
            </select>
        </div>
        </div>
        ...
        <div class="form-group">
                ...
                <!-- <?php echo anchor('administrator/perorangan','<div class="btn btn-warning">Back</div>'); ?> -->
                </div>
        </div>
        <?php endforeach; ?>
    </form>

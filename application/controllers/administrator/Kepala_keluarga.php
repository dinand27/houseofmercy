 ...
 public function tambah_orang(){
    ...
    public function tambah_kepalakel_aksi()
    {
        ...
        if($this->form_validation->run()== FALSE){
            ...
            $this->Kepalakeluarga_model->insert_data($data, 'kepala_keluarga');
      ...
      /*  $this->form_validation->set_rules('nama','nama', 'required',['required'=> 'Nama Wajib diisi']);
	   ...
	   public function update($id)
	   {
		   $where= array('id_kepkel' => $id);
            ...
            $data['hobi']= $this->Kepalakeluarga_model->tampil_data_hobi('hobi')->result();
            $data['sektor']= $this->Kepalakeluarga_model->tampil_data_sektor('sektor')->result();
			$data['kepala_keluarga']= $this->Kepalakeluarga_model->edit_data($where,'kepala_keluarga')->result();
		    $this->load->view('templates_administrator/header');
			$this->load->view('templates_administrator/sidebar');
	   ...
	   public function update_aksi(){
        ...
        $data= array(
		   ...
		   $this->Kepalakeluarga_model->update_data($where, $data,'kepala_keluarga');
		   $this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
...
//blok filter cari
    ...
    public function cari_hutLahir(){
        ...
        $data['data']= $this->Kepalakeluarga_model->tampil_data('kepala_keluarga')->result();
    ...
    public function delete($id){
        $where= array('id_kepkel'=> $id);
        $this->Kepalakeluarga_model->hapus_data($where, 'kepala_keluarga');
    ...
    public function cetak(){
        $data['kepala_keluarga']= $this->Kepalakeluarga_model->tampil_data('data_perorangan')->result();
        $this->load->view('templates_administrator/header');
